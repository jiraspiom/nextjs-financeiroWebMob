...
export default function SideBar() {
  return (
    <>
      <aside
        id="default-sidebar"
        className="fixed left-0 top-0 z-40 h-screen w-60 -translate-x-full transition-transform sm:translate-x-0"
        aria-label="Sidebar"
      >
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3 flex-1 whitespace-nowrap">Contas</span>
              </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              <Link
                ...
                className="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              >
                <span className="ml-3 flex-1 whitespace-nowrap">sessao</span>
              </Link>
            </li>
